          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-emerald-100 flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl font-black text-gray-800">Deepak Verma</h2>
                <p className="text-emerald-600 font-bold text-sm tracking-wide bg-emerald-50 px-3 py-1 rounded-full mt-2 mb-6">Senior Risk Analyst</p>

                <div className="w-full space-y-3 text-left">
                  <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50 p-2 rounded-lg border border-gray-100">
                    <Building size={16} className="text-gray-400" /> Standard Chartered Bank
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50 p-2 rounded-lg border border-gray-100">
                    <Briefcase size={16} className="text-gray-400" /> APAC Risk Division
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50 p-2 rounded-lg border border-gray-100">
                    <Mail size={16} className="text-gray-400" /> d.verma@sc.com
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50 p-2 rounded-lg border border-gray-100">
                    <Shield size={16} className="text-emerald-500" /> Level 3 Clearance (Systemic Data)
                  </div>
                </div>
              </div>
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-emerald-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { name: 'High Volatility Midcaps', count: 14, alert: true },
                    { name: 'PSU Banks Tier 2', count: 8, alert: false },
                    { name: 'Core Infrastructure Long', count: 22, alert: false },
                    { name: 'Auto Sector EV Transition', count: 6, alert: true },
                  ].map((w, i) => (
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-emerald-100">
                ...
                <div className="space-y-2">
                  {[
                    { term: '"Adani Ports liquidity stress test"', time: '2 hours ago', icon: <Search size={14}/> },
                    { term: 'Compared HDFC vs ICICI metrics', time: 'Yesterday', icon: <Star size={14}/> },
                    { term: '"Fed rate hike impact on IT exports"', time: '3 days ago', icon: <Search size={14}/> },
                  ].map((s, i) => (
